...
namespace WebSiteCrawler.Sites
{
    ...
    public class Bbc : WebSite
    {
        ...
        {
            var html = "https://www.bbc.com/news/topics/ce1qrvleleqt/artificial-intelligence";
        ...
        public override void Crawl()
        {
            ...
            foreach (string link in links)
            {
                ...
                MyArticle myArticle = JsonConvert.DeserializeObject<MyArticle>(json);
                ReleaseDate = myArticle.datePublished;
