...
{
    public class Phys : WebSite
    {
        public Phys(ApplicationDbContext context) : base(context)
        {
            this.Name = "phys";
            SetRootUrl();
        }
        public override List<string> GetLinks()
        {
            ...
            var links = htmlDoc.DocumentNode.SelectNodes("//article[contains(@class, 'sorted-article')]//a[1][contains(@class, 'news-link')]");
